use crate::database::{
    case::http_routes as CaseHttp, cooling::http_routes as CoolingHttp,
    motherboard::http_routes as MbHttp, power_unit::http_routes as PowerUnitHttp,
    storage::http_routes as StorageHttp, users::http_routes as UserHttp,
    CPU::http_routes as CpuHttp, GPU::http_routes as GpuHttp, RAM::http_routes as RamHttp,
};
...
pub fn myconfig(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::resource("motherboard/insert").route(web::post().to(MbHttp::insert_motherboard)),
    );
    cfg.service(
        web::resource("power_unit/insert").route(web::post().to(PowerUnitHttp::insert_power_unit)),
    );
    ...
    cfg.service(
        web::resource("motherboard/update").route(web::put().to(MbHttp::update_motherboard)),
    );
    cfg.service(
        web::resource("power_unit/update").route(web::put().to(PowerUnitHttp::update_power_unit)),
    );
    ...
    cfg.service(
        web::resource("storage/delete").route(web::delete().to(StorageHttp::delete_storage)),
    );
    cfg.service(web::resource("case/delete").route(web::delete().to(CaseHttp::delete_case)));
    cfg.service(
        web::resource("cooling/delete").route(web::delete().to(CoolingHttp::delete_cooling)),
    );
    cfg.service(
        web::resource("motherboard/delete").route(web::delete().to(MbHttp::delete_motherboard)),
    );
    cfg.service(
        web::resource("power_unit/delete")
            .route(web::delete().to(PowerUnitHttp::delete_power_unit)),
    );
